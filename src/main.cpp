...
public:
    TCPv4Connection(const std::string& address, int port, bool isBlocking)
...
public:
    TCPv6Connection(const std::string& address, int port, bool isBlocking)
        : Connection(address, port, isBlocking) {}
    bool bind() override {
        // Implementación del método bind
        return true;
...
public:
    UDPv4Connection(const std::string& address, int port, bool isBlocking)
        : Connection(address, port, isBlocking) {}
    bool bind() override {
        // Implementación del método bind
        return true;
...
public:
    UDPv6Connection(const std::string& address, int port, bool isBlocking)
        : Connection(address, port, isBlocking) {}
    bool bind() override {
        // Implementación del método bind
        return true;
